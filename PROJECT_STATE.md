...
_Last updated: 2026-09-21 · Full-Stack — NEW `GET /api/data-backup` (the actual Neon data — pg_dump or a full CSV-per-table fallback — downloadable straight off the running server). Awaiting deploy-dev. See AGENT_UPDATE_LOG.md._
